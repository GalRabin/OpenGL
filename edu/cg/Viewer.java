...
public class Viewer {
    ...
    // TODO-DONE(0): You can add (sub)-models here to see how they are rendered in their local coordinate system.
    ...
    public void init() {
        // TODO-DONE(*) In your final submission you need to make sure that BACK FACE culling is enabled.
    ...
    public void reshape(int x, int y, int width, int height) {
        // TODO-DONE(9) Set the projection matrix to be the perspective matrix in the final submission.
        canvasWidth = width;
        canvasHeight = height;
        glMatrixMode(GL_PROJECTION);
        glLoadIdentity();

        glFrustum(-1*Specification.BASE_UNIT,
                Specification.BASE_UNIT,
                -(Specification.BASE_UNIT * height / width),
                Specification.BASE_UNIT * height / width,
                Specification.BASE_UNIT,
                400);
    }
